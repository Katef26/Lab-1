...
visitors %>% 
  summarise(
    mean_2021 = mean(n_2022, na.rm = TRUE),
...
**NA stands for not available we get this because one of the entries is NA**
...
**na.rm means NA remove when it is set to true**
...
**Some of the data is very big compared to others which are very small which makes the mean much larger**
